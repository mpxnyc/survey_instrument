...
export function getAvailableQuestions(surveyData, questionCurrent, questionHistory, questionList) {
    ...
    const result = questionList
        ...
        .filter((item) => {
            ...
            const result = allowedSkip && (futureQuestion || (questionnaire[item].skipLogic  && surveyData[questionnaire[item].skipLogic.question] === "" && skipLogicIndex < lastQuestionIndex))
