...
import InputUserNameConfirm from "../components/InputUserNameConfirm";
...
export const getQuestionFormat = (questionType, data, handleUpdateData, currentQuestion, language, colorBackground, colorText) => {
    ...
    const questionFormats = {
        ...
        user_name_confirm: {
            ...
            navigationType: questionFormatProperties.user_name_confirm.navigationType,
            baseType: questionFormatProperties.user_name_confirm.baseType
        },
        user_name_assign: {
            component:
                <Box sx={{ my: 4 }}>
            ...
            navigationType: questionFormatProperties.user_name_assign.navigationType,
            baseType: questionFormatProperties.user_name_assign.baseType
        },
        checkbox:{
            component:
                <Box sx={{ my: 4 }}>
