...
import OutputUserNameDisplay from "../components/OutputUserNameDisplay";
    ...
    const questionFormats = {
        ...
        radio_with_username_display: {
            component:                <Box
                ...
                height={"100%"}
            >
                <Typography margin={2} color={colorText} variant={"h3"}>{questionnaire[currentQuestion] && questionnaire[currentQuestion].heading && questionnaire[currentQuestion].heading[language]}</Typography>
            ...
            navigationType: questionFormatProperties.radio_with_username_display.navigationType,
            baseType: questionFormatProperties.radio_with_username_display.baseType
        },
        checkbox:{
            component:
                <Box sx={{ my: 4 }}>
