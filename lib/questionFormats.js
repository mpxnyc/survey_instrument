    ...
    const questionFormats = {
        ...
        radio_with_username_display: {
            component:                <Box
                ...
                height={"100%"}
            >
                <Typography color={colorText} variant={"h3"}>{questionnaire[currentQuestion] && questionnaire[currentQuestion].heading && questionnaire[currentQuestion].heading[language]}</Typography>
