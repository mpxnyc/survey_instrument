...
class CantRetrieveData extends Error {
    constructor() {
        super()
        this.name = 'CantGetID';
        this.message = 'We could not retrieve your data. Double check internet connection?';
        this.header = 'Uh Oh!';
    }
}
...
class CantSaveEmail extends Error {
    constructor() {
        ...
        this.message = 'We could not save your Email address. Try again?';
        this.header = 'Uh Oh!';
    }
}
class CantPlayViral extends Error {
    constructor() {
        super()
        this.name = 'CantSaveEmail';
        this.message = 'We could not connect to the game server. Try again later?';
        this.header = 'Uh Oh!';
    }
}
